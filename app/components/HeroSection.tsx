...
const HeroSection = () => {
  return (
    <div className="relative bg-[radial-gradient(circle,rgba(56,56,56,1)_0%,rgba(12,12,12,1)_100%)] overflow-hidden">
      <div className="relative flex flex-col min-h-[calc(100vh)] p-(--spacing-s) hero-section max-w-[1024px] mx-auto pt-[50px]">
    ...
    text-transparent font-heading pt-[16px] font-bold text-[clamp(2rem,_15vw,_158px)] uppercase leading-none tracking-wide m-0 p-0 text-nowrap"
          >
            CHRISTINA GRAMMA
          </h1>
          <h2
    ...
    text-transparent"
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center z-10">
          ...
          <FadeContent className="flex flex-col gap-6 mb-[32px] md:col-span-6 lg:col-span-5 z-30">
            ...
            <span className="text-center text-md  md:text-start text-base text-white font-medium leading-relaxed">
