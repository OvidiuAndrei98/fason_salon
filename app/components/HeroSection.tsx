...
const HeroSection = () => {
  return (
    <div className="relative flex flex-col min-h-[calc(100vh + 100px)] p-[var(--spacing-s)] hero-section max-w-[1024px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center z-10">
        ...
        <div className="flex flex-col gap-6 mb-[32px] md:col-span-6 lg:col-span-5 z-30">
          <Image
            ...
            height={800}
          />
          <span className="text-center text-md  md:text-start text-xl text-secondary-foreground ">
