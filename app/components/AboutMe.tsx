  ...
  return (
    <div className="flex flex-col items-center w-full relative">
      ...
      <div className="w-full flex flex-col pr-2 md:pr-0 md:flex-row gap-6 md:gap-4 lg:gap-10">
        ...
        >
          <div className="aspect-3/4 md:aspect-auto flex flex-col gap-2 justify-end p-[32px] bg-[linear-gradient(180deg,rgba(204,204,204,0)_14%,rgba(0,0,0,1)_100%),url('/CRISTINA.png')] h-[100%] object-contain bg-center bg-no-repeat bg-cover m-auto md:m-0 md:mb-0 rounded-4xl shadow-[2px_4px_44px_0px_rgba(0,_0,_0,_0.8)]">
