const AboutMe = () => {
  return (
    <div className="flex flex-col items-center w-full ">
      ...
      <div className="w-full flex flex-col-reverse pr-2 md:pr-0 flex-col space-between md:flex-row gap-6 md:gap-4 lg:gap-10  w-full">
        <div className="bg-accent/15 p-4 md:p-0 flex flex-col gap-4 items-center md:items-start md:[padding-left:clamp(0.5rem,calc((100vw-1024px)/2),50vw)] md:pr-[50px] md:py-[50px]  text-xl rounded-tr-4xl rounded-br-4xl">
          <h2 className="text-secondary-foreground font-heading text-4xl font-extrabold tracking-wide">
            CHRISTINA GRAMMA
          </h2>
          <p className="pb-2 w-full text-center md:text-start">
        ...
        <div className="w-full pl-2 md:[padding-right:clamp(0.5rem,calc((100vw-1024px)/2),50vw)]">
          <div className="aspect-3/4 md:aspect-auto flex flex-col gap-2 justify-end p-[32px] bg-[linear-gradient(180deg,rgba(204,204,204,0)_14%,rgba(0,0,0,1)_100%),url('/CHRISTINA.jpg')] h-[100%] object-contain bg-center bg-no-repeat bg-cover  m-auto md:m-0 md:mb-0 rounded-4xl shadow-[2px_4px_44px_0px_rgba(0,_0,_0,_0.8)]">
